...
@api.route('/api/get_lonlatalt_list/<string:s><float:starthour>,<float:startminute>,<float:startsecond>/<float:endhour>,<float:endminute>,<float:endsecond>/<float:interval>')
def lonlatalt_list(s, startTime, endTime, interval):
    return track.Tracker(s).get_lonlatalt_list(datetime.time(starthour, startminute, startsecond), datetime.time(endhour, endminute, endsecond), interval)
